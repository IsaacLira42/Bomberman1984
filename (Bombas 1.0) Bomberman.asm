...
loopPrincipal:
	...
	desenharTodasAsBombas:
		# Player
		bomba1:
			lui $9, 0x1002
			lw $8, 24($9)  # sição da bomba
			beq $8, $0, bomba2   # Verificar se a bomba 1 existe
			
			jal desenharBomba
		bomba2:
			lui $9, 0x1002
			lw $8, 32($9)  # sição da bomba
				  ### TEMPORARIO ##
			beq $8, $0, loopPrincipal   # Verificar se a bomba 1 existe
...
iniciarVariaveisDosPersonagens:
	...
	addi $8, $8, 4 
	# OBS: atualiar a linha 302 se modificar o tempo de movimentação
	...
	addi $25, $0, 1000  # Tempo inicial é 1000 iteraç~oes
	sw $25, 0($8)
	sw $25, 512($8)
	sw $25, 1024($8)
	sw $25, 1536($8)
...
# Sujos: $8, $9
# Saida: ---
# $8: ira conter a posiç~o da bomba
